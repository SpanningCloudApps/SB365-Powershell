...
### None (Default)
```
Disable-SpanningUsersfromCSVAdvanced [[-AuthInfo] <Object>] -Path <ValidateNotNullOrEmptyAttribute>
...
```
Disable-SpanningUsersfromCSVAdvanced [[-AuthInfo] <Object>] -Path <ValidateNotNullOrEmptyAttribute>
 -UpnColumn <ValidateNotNullOrEmptyAttribute> [-FilterColumn <ValidateNotNullOrEmptyAttribute>]
