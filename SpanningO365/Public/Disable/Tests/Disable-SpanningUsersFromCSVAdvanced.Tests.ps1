...
Describe 'Disable-SpanningUsersFromCSVAdvanced Tests' -Tag "Structure" {
   ...
   Context 'Parameters for Disable-SpanningUsersFromCSVAdvanced'{
        ...
        It 'Does FilterColumn Parameter use advanced parameter Validation? ' {
            $Function.Parameters.FilterColumn.Attributes.TypeID.Name -contains 'ValidateNotNullOrEmptyAttribute' | Should -Be 'True'
