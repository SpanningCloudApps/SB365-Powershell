Describe 'Disable-SpanningUsersFromCSVAdvanced Tests' {

   Context 'Parameters for Disable-SpanningUsersFromCSVAdvanced'{
        ...
        It 'FilterColumn Parameter is of ValidateNotNullOrEmptyAttribute Type' {
            $Function.Parameters.FilterColumn.ParameterType.FullName | Should be 'System.Management.Automation.ValidateNotNullOrEmptyAttribute'
            }
