...
Describe 'Get-SpanningAuthentication Tests' -Tag "Structure" {
   ...
   Context 'Parameters for Get-SpanningAuthentication'{
        ...
        It 'Does Region Parameter have 5 Valid Values?' {
            $Function.Parameters.Region.Attributes.ValidValues.count | Should -Be 5
        }
